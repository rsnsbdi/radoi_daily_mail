...
public class Activity_EconomicNews_Description extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_economicnews_description);
        ...
        news_image = (ImageView) findViewById(R.id.economicnews_image_desc);
        title = (TextView) findViewById(R.id.economicnews_title_desc);
        description = (TextView) findViewById(R.id.economicnews_long_description);
        datetime=(TextView) findViewById(R.id.economicnews_datetime_desc);
        btnWeb = (Button) findViewById(R.id.btnViewWeb);
        btnShare=(Button) findViewById(R.id.btnSharePost);

        Intent intent = getIntent();
        final EconomicNewsReceiveParams.News23Bean allnews = (EconomicNewsReceiveParams.News23Bean) intent.getSerializableExtra("obj");
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(Activity_EconomicNews_Description.this,Activity_NavigationDrawer.class);
        intent.putExtra("economic_back",7);
