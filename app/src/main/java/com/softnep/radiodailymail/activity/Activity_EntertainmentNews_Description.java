...
public class Activity_EntertainmentNews_Description extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_entertainmentnews_description);
        ...
        news_image = (ImageView) findViewById(R.id.entertainmentnews_image_desc);
        title = (TextView) findViewById(R.id.entertainmentnews_title_desc);
        description = (TextView) findViewById(R.id.entertainmentnews_long_description);
        datetime=(TextView) findViewById(R.id.entertainmentnews_datetime_desc);
        btnWeb = (Button) findViewById(R.id.btnViewWeb);
        btnShare=(Button) findViewById(R.id.btnSharePost);

        Intent intent = getIntent();
        final EntertainmentNewsReceiveParams.News28Bean allnews = (EntertainmentNewsReceiveParams.News28Bean) intent.getSerializableExtra("obj");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent=new Intent(Activity_EntertainmentNews_Description.this,Activity_NavigationDrawer.class);
        intent.putExtra("entertainment_back",6);
